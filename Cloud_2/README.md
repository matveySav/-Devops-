...
## Результат
С помощью официальной документации продуктов Azure и документации Bicep (язык для деплоя продуктов Azure пользователям) для сопоставления ресурсов и сервисов с ними связанными. Получаем
